...
<div class="row">
	...
	<aside class="col-sm-3 col-md-2 sidebar">
		<h1>Hi, Tom.</h1>
		<img src="../images/zelda.png" id="profile_photo" class="img-thumbnail">
		<h2>Classes</h2>
		<ul>
			<li><a href="" class="out">Environmental Science <span class="glyphicon glyphicon-chevron-right"></span></a></li>
			<li><a href="" class="out">Geometry <span class="glyphicon glyphicon-chevron-right"></span></a></li>
			<li><a href="" class="out">U.S. History <span class="glyphicon glyphicon-chevron-right"></span></a></li>
		</ul>
	</aside>
